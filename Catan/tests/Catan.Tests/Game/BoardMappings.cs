internal static class BoardMappings
{
    ...
    // Which edges does a tile see
    internal static readonly int[][] TileToEdgesAdjacencyMapping = new int[][]
    {
    ...
    {
        new int[]{0, 3, 4, 7, 8, 12}, // 0
        new int[]{1, 4, 5, 8, 9, 13}, // 1
        new int[]{2, 5, 6, 9, 10, 14}, // 2
        new int[]{7, 11, 12, 16, 17, 22}, // 3
        new int[]{8, 12, 13, 17, 18, 23}, // 4
        new int[]{9, 13, 14, 18, 19, 24}, // 5
        new int[]{10, 14, 15, 19, 20, 25}, // 6
        new int[]{16, 21, 22, 27, 28, 33}, // 7
        new int[]{17, 22, 23, 28, 29, 34}, // 8
        new int[]{18, 23, 24, 29, 30, 35}, // 9
        new int[]{19, 24, 25, 30, 31, 36}, // 10
        new int[]{20, 25, 26, 31, 32, 37}, // 11
        new int[]{28, 33, 34, 38, 39, 43}, // 12
        new int[]{29, 34, 35, 39, 40, 44}, // 13
        new int[]{30, 35, 36, 40, 41, 45}, // 14
        new int[]{31, 36, 37, 41, 42, 46}, // 15
        new int[]{39, 43, 44, 47, 48, 51}, // 16
        new int[]{40, 44, 45, 48, 49, 52}, // 17
