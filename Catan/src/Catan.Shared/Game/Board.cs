...
public class Board
{
    ...
    private void InitializeVertices()
    {
        ...
        {
            var adjacentTiles = adjacencyMapping[i].Select(index => Tiles[index]).ToList();
            Vertices.Add(new Vertex(adjacentTiles));
        }
    }
    private void InitializeEdges() 
    { 
        int[][] edgeMapping = new int[][]
        {
            new int[]{0, 3}, // 0
            new int[]{0, 4}, // 1
            new int[]{1, 4}, // 2
        ...
        foreach (var pair in edgeMapping)
        {
