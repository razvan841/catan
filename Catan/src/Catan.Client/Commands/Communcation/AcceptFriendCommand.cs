...
public class AcceptFriendCommand : ICommandHandler
{
    private readonly ClientSender _sender;
    private readonly MainWindow _ui;
    private readonly ClientSession _session;

    public string[] Aliases => new[] { "yes" };

    public AcceptFriendCommand(ClientSender sender, MainWindow ui, ClientSession session)
    {
        _sender = sender;
        _ui = ui;
        _session = session;
